...
//
//public class H2Ej4_LibroVariosAutores {
//
...
//	static Autor[] autauxvector = new Autor[100];
//
////	-------------------DIBUJAR MENU--------------
...
//			}
//
//			for (int i = 0; i < autauxvector.length; i++) {
//				if (autauxvector[i] == null) {
//					autauxvector[i] = autaux;
//					i = autauxvector.length;
//				}
//			}
//			res = Leer.leerString("Tiene más autores? S/N").charAt(0);
//
//		} while (res == 's');
//		return autauxvector;
//	}
...
//			break;
//		case 2:
//			System.out.println("Elige autor a modificar;");
//			int o = Leer.leerInt(""); 
////			visualizarAutor(libro.ge);
