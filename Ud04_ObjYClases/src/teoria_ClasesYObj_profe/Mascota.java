...
public class Mascota {
	...
	private int edad;
	// indexar un propietario de la clase Persona
	...
	public String toString() {
		if (propietario != null) 
			return String.format("Soy un %s, me llamo %s y tengo %d años. %n Propietario: %s ",tipo,nombre,edad, propietario);
		else
	...
	public void setPropietario(Dueno due1) {
